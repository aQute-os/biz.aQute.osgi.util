...
public interface Authority {
	 ...
	 * @throws Exception
	 */
	boolean hasPermission(String permission, String... arguments);
	 ...
	 *             caller
	 */
	default void checkPermission(String permission, String... arguments) {
		if ( !hasPermission(permission, arguments))
			throw new SecurityException("permission "+permission + " is not granted to " + getUserId() + " for " + Arrays.toString(arguments) + " on thread " + Thread.currentThread());
	}
}
