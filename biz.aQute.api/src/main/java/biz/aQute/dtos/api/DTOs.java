...
public interface DTOs {
	 ...
	 * @throws Exception
	 */
	Converter convert(Object source);
	 ...
	 */
	interface Enc {
		void put(OutputStream out);

		void put(OutputStream out, String charset);

		void put(Appendable out);
	...
	interface Dec<T> {
		 ...
		 * @throws Exception
		 */
		T get(InputStream in, String charset);
	 ...
	 * @throws Exception
	 */
	<T> Dec<T> decoder(TypeReference<T> type);
	 ...
	 * @throws Exception
	 */
	Dec<?> decoder(Type type, InputStream source);
	...
	Result<Object> get(Object dto, String path);
	 ...
	 * @throws Exception
	 */
	Result<Object> set(Object dto, Object value, String path);
