...
public interface Authenticator {
	 ...
	 * <p>
	 * The password may also be a certificate or a public key
	 */
	String	BASIC_SOURCE			= "basic.source";

	/**
	 * The property key for a password with the {@link #BASIC_SOURCE}. The
	 * password can be binary and represent a public key or certificate
	 */
	 ...
	 * @throws Exception
	 */
	String authenticate(Map<String, Object> arguments, String... sources);
