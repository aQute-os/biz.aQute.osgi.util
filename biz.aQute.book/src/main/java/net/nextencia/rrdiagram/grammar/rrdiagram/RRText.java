...
public class RRText extends RRElement {
  ...
  protected void toSVG(RRDiagramToSVG rrDiagramToSVG, int xOffset, int yOffset, SvgContent svgContent) {
    ...
    switch(shape) {
      case RECTANGLE:
        svgContent.addElement("<rect class=\"" + cssClass + "\" x=\"" + xOffset + "\" y=\"" + (yOffset+4) + "\" width=\"" + width + "\" height=\"" + (height-4) + "\"/>");
        break;
      case ROUNDED_RECTANGLE:
        ...
        svgContent.addElement("<rect class=\"" + cssClass + "\" x=\"" + xOffset + "\" y=\"" + (yOffset+4) + "\" width=\"" + width + "\" height=\"" + (height-4) + "\" rx=\"" + rx + "\"/>");
        break;
      case HEXAGON:
