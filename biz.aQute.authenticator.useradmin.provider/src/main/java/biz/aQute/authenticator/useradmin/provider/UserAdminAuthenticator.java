...
import biz.aQute.authentication.api.AuthenticationConstants;
import biz.aQute.authentication.api.Authenticator;
import biz.aQute.authenticator.useradmin.provider.Config.Algorithm;
	...
	public String authenticate(Map<String, Object> arguments, String... sources) {
		...
		for (String source : sources)
			try {
				...
				log.warn("error during authentication {}", e, e);
			}
		return null;
	}
