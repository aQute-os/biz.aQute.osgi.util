...
<dependency>
    ...
    <artifactId>biz.aQute.osgi.logger.tracker.util</artifactId>
...
```
Bundle Symbolic Name: biz.aQute.osgi.logger.tracker.util
...
"bundles": [
   {
    "id": "biz.aQute:biz.aQute.osgi.logger.tracker.util:1.3.0-SNAPSHOT"
   }
]
```
