...
public class CronAdjusterTest {
	...
	public void testSimple() {
		...
		assertCron("2015-01-01T00:00:00", "0 15 10 1/10 * ?", "2015-01-01T10:15", "2015-01-11T10:15", "2015-01-21T10:15", "2015-01-31T10:15",
				"2015-02-01T10:15");
		...
		assertCron("2015-01-01T00:00:00", "0 0-2 14 * * ?", "2015-01-01T14:00", "2015-01-01T14:01", "2015-01-01T14:02", "2015-01-02T14:00", "2015-01-02T14:01",
				"2015-01-02T14:02");
		assertCron("2015-01-01T00:00:00", "0 0/15 14,18 * * ?", "2015-01-01T14:00", "2015-01-01T14:15", "2015-01-01T14:30", "2015-01-01T14:45",
	...
	void assertCron(String in, String cron, String... outs) {
		final CronAdjuster c = new CronAdjuster(cron);
		Temporal ldt = LocalDateTime.parse(in);

		for (final String out : outs) {
			final Temporal t = c.adjustInto(ldt);
