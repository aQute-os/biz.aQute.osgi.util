...
public class Bytes extends BaseQuantity<Bytes> {
	...
	private static final double	TERA	= GIGA * 1024;
	private static final double	PETA	= TERA * 1024;
	private static final double	EXA		= PETA * 1024;
	private static final double	ZETTA	= EXA * 1024;
	private static final double	YOTTA	= ZETTA * 1024;
